        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-item nav-link" href="shop.php">Market</a>
                        ...
                        <div class="container">
                            ...
                            <div class="custum_menu">
                                ...
                                <li><a href="../home/index.php">Home</a></li>
                                    <li class="active"><a href="shop.php">Market</a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="footer_links">
                        <ul>
                        <li><a href="shop.php">MarketPlace</a></li>
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="footer_links">
                        <ul>
                            <li><a href="shop.php">Seasonal Produce</a></li>
                            <li><a href="shop.php">Organic Foods</a></li>
                            <li><a href="shop.php">Gardening Supplies</a></li>
                            <li><a href="shop.php">Meal Kits</a></li>
                            <li><a href="shop.php">And more</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
