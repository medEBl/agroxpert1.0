...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (
        ...
        !empty($_POST["titrePost"]) && !empty($_POST["contenuPost"]) && 
        $_POST["typeuser"] !== "" && $_POST["typepost"] !== "" && // Ensure dropdowns are not empty
        ...
        $error = "Please fill in all fields, including valid dropdown selections.";
    }
}
?>
...
<body>
    <div class="container">
        <div class="main-content">
            ...
            <?php if ($post) : ?>
                <form id="forumForm" action="updatepost.php?idpost=<?= htmlspecialchars($post['idpost']); ?>" method="POST">
                    ...
                    <select id="typeuser" name="typeuser" required>
                        <option value="">Select User Type</option> <!-- Default invalid -->
                    ...
                    <select id="typepost" name="typepost" required>
                        <option value="">Select Post Type</option> <!-- Default invalid -->
